            ...
            if (typeof user !== 'object')
                ...
                if (user) {
                  ...
                  if (!user.rtrofi) user.rtrofi = 'Perunggu'
                    ...
                    if (!('antiLinkGc' in chat)) chat.antiLinkGc = true
                    ...
                    if (!('antiVirtex' in chat)) chat.antiVirus = true
                    if (!('antiStiker' in chat)) chat.antiSticker = false
...
*.delete*`, author, '⫷ Matikan Fitur ⫸', '.off antidelete', '⫷ Menu ⫸', '.menu', msg, adReply)
