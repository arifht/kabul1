...
let em = res.emoji
  ...
  let arrayMenu = ['all', 'anime', 'update', 'maker', 'berita', 'edukasi', 'news', 'random', 'logo', 'menbalas', 'game', 'xp', 'islamic', 'stiker', 'rpg', 'kerangajaib', 'quotes', 'admin', 'group', 'premium', 'internet', 'anonymous', 'nulis', 'downloader', 'tools', 'fun', 'database','quran', 'vote', 'virus', 'nsfw', 'audio', 'jadibot', 'info', 'audioanime', 'owner', 'nocategory']
...
const sections = [
   {
    ...
    rows: [
        ...
        {title: `${emot} RUNTIME BOT`, rowId: ".runtime", description: "𝙼𝚎𝚗𝚊𝚖𝚙𝚒𝚕𝚔𝚊𝚗 Waktu Bot Berjalan"}, 
        ...
        {title: `${emot} Group ZykoBotz-MD`, rowId: ".gcbul", description: "Group ZykoBotz-MD Official"},
        ...
        {title: `${emot} Logo`, rowId: ".? logo", description: "Buat Logo Kamu diBOT"},
        {title: `${emot} Nulis`, rowId: ".? nulis", description: "Nulis kok males kak?"},
        {title: `${emot} Audio Anime`, rowId: ".? audioanime", description: "Kamu wibu ya bang?"},
        ...
        {title: `${emot} Sound Kane Menu`, rowId: ".soundkanemenu", description: "Kumpulan 24 Sound"},
        ...
        {title: `${emot} VIRUS`, rowId: ".? virus", description: "Husus Onwer ZykoBotz-MD"},
        {title: `${emot} No Category`, rowId: ".? nocategory", description: "Fitur tanpa kategory!"},
        ]
        },
]
...
├━━━━━━━━━━━━━━━━┈─⋆
│  「 *I n f o   B o t 比* 」
│${emot} Nama Group *${groupMetadata.subject}*
