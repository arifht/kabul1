...
let em = res.emoji
  ...
  let arrayMenu = ['all', 'anime', 'virus', 'update', 'maker', 'berita', 'edukasi', 'news', 'random', 'logo', 'menbalas', 'game', 'xp', 'islamic', 'stiker', 'rpg', 'kerangajaib', 'quotes', 'admin', 'group', 'premium', 'internet', 'anonymous', 'nulis', 'downloader', 'tools', 'fun', 'vote', 'database','quran', 'vote', 'nsfw', 'audio', 'jadibot', 'info', 'owner', 'nocategory']
...
const sections = [
   {
    ...
    rows: [
        ...
        {title: `${pmenus} VIRUS`, rowId: ".? virus", description: "husus Owner ZykoBotz-MD"},
